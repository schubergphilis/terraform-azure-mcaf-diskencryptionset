...
* feat: align MCAF provider versions (#5) @niekvanraaij

#### 🐛 Bug Fixes

* fix: revert align MCAF provider versions (#6) @jorrite

**Full Changelog**: https://github.com/schubergphilis/terraform-azure-mcaf-diskencryptionset/compare/v0.3.1...v0.4.0
