<!-- migrate-repo:banner -->
> [!IMPORTANT]
> **This repository has moved to [`schubergphilis-ep/terraform-azure-mcaf-diskencryptionset`](https://github.com/schubergphilis-ep/terraform-azure-mcaf-diskencryptionset).**
